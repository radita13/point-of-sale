...
const buttonVariants = cva(
  'neo-press inline-flex items-center justify-center gap-2 rounded-xl border-2 border-ink font-extrabold select-none disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
